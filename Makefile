...
android: android_client.o
	${CC} -o android_client client.o strlcat.o strlcpy.o mbd_utils.o mkpath.o slist.o mptcp_ctrl.o gen_uuid.o pack.o unpack.o -Llib -lcurl -lconfig -lsodium -lcares
client: client.o
	${CC} -o client client.o strlcat.o strlcpy.o mbd_utils.o mkpath.o slist.o mptcp_ctrl.o -L/usr/lib/x86_64-linux-gnu -lcurl -luuid -lconfig -lsodium -lcares
