...
client.o: client.c utils/mbd_utils.c utils/mbd_utils.h set_version
	gcc -O0 -ggdb -c client.c utils/strlcat.c utils/strlcpy.c utils/mbd_utils.c utils/mkpath.c utils/slist.c
client: client.o
	gcc -o client client.o strlcat.o strlcpy.o mbd_utils.o mkpath.o slist.o -L/usr/lib/x86_64-linux-gnu -lcurl -lconfig -lsodium -luuid -lcares
