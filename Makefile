...
client: client.o
	gcc -o client client.o strlcat.o strlcpy.o mbd_utils.o mkpath.o -L/usr/lib/x86_64-linux-gnu -lcurl -lconfig -lsodium -luuid
server.o: server.c utils/mbd_utils.c utils/mbd_utils.h utils/mongoose.c utils/mbd_utils.h utils/mongoose.h set_version
